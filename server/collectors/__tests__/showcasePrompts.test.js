...
test("DecodeBench uses typed bench prompts at temperature 0, thinking off", () => {
  assert.match(benchSrc, /pickDecodeBenchPrompts\(count,\s*type\)/);
  assert.match(benchSrc, /decodeBenchPromptForType\(promptType\)/);

...
/** Restart-safe cumulative LLM token counters (gitignored). */
const LLM_LIFETIME_JSON_PATH =
  process.env.LLM_LIFETIME_JSON_PATH || path.join(ROOT, "config", "llm-lifetime.json");
